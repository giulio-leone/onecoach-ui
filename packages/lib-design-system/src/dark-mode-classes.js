...
export const darkModeClasses = {
    ...
    bg: {
        ...
        // Gradients
        gradient: 'bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-neutral-900 dark:to-neutral-800',
        gradientPrimary: 'bg-gradient-to-r from-primary-600 to-primary-700 dark:from-primary-500 dark:to-primary-600',
        // Disabled
    ...
    border: {
        ...
        focus: 'focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/30',
    ...
    interactive: {
        ...
        active: 'active:bg-neutral-100 dark:active:bg-neutral-700/70 active:scale-[0.98] transition-all duration-150',
        focus: 'focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/30 focus:outline-none transition-all duration-200',
        focusVisible: 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/20 dark:focus-visible:ring-blue-400/30 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-neutral-900 transition-all duration-200',
    ...
    card: {
        ...
        elevated: 'bg-white dark:bg-neutral-800 shadow-md dark:shadow-xl dark:shadow-neutral-950/60 border border-neutral-200 dark:border-neutral-700/80 rounded-2xl',
        hover: 'hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-all duration-200 ease-out',
        interactive: 'bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700/80 hover:border-blue-400 dark:hover:border-blue-500/60 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-neutral-950/50 transition-all duration-200 ease-out rounded-2xl',
        glass: 'bg-white/90 dark:bg-neutral-800/90 backdrop-blur-md border border-neutral-200 dark:border-neutral-700/60 shadow-md dark:shadow-lg dark:shadow-neutral-950/50 rounded-2xl',
    },
    ...
    input: {
        ...
        disabled: 'bg-neutral-100 dark:bg-neutral-900/50 text-neutral-500 dark:text-neutral-500 cursor-not-allowed opacity-50',
        ...
        focus: 'focus:ring-4 focus:ring-emerald-500/30 dark:focus:ring-emerald-400/30 focus:border-emerald-500 dark:focus:border-emerald-400 focus:shadow-lg focus:shadow-emerald-500/20 dark:focus:shadow-lg dark:focus:shadow-emerald-400/20 focus:shadow-[0_0_0_3px_rgba(16,185,129,0.1)] dark:focus:shadow-[0_0_0_3px_rgba(16,185,129,0.15)]',
    },
    // Navigation - Enhanced
    nav: {
    ...
    // Table specific
    table: {
        header: 'bg-neutral-50 dark:bg-neutral-800/50 border-b border-neutral-200 dark:border-neutral-700',
        ...
        rowEven: 'bg-neutral-50 dark:bg-neutral-800/30 hover:bg-neutral-100 dark:hover:bg-neutral-800/60',
    ...
    transaction: {
        container: 'rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm dark:shadow-2xl dark:shadow-neutral-950/50',
        ...
        iconPositive: 'rounded-full bg-green-100 dark:bg-green-900/40 p-2 border border-green-200 dark:border-green-800',
        iconNegative: 'rounded-full bg-red-100 dark:bg-red-900/40 p-2 border border-red-200 dark:border-red-800',
        iconNeutral: 'rounded-full bg-neutral-100 dark:bg-neutral-700/50 p-2 border border-neutral-200 dark:border-neutral-600',
    ...
    // Empty states
    emptyState: {
        container: 'rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-8 sm:p-12 text-center shadow-sm dark:shadow-2xl dark:shadow-neutral-950/50',
    ...
    loading: {
        ...
        container: 'rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-4 sm:p-6',
    },
    // Chat specific - Deep dark mode
    chat: {
        container: 'rounded-2xl border-2 border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-xl dark:shadow-2xl dark:shadow-neutral-950/50',
        messageArea: 'bg-white dark:bg-neutral-800',
        welcomeBubble: 'rounded-2xl border-2 border-purple-100 dark:border-purple-800/50 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/30 dark:to-neutral-800 p-4 shadow-sm dark:shadow-lg dark:shadow-purple-950/30 sm:p-6',
        suggestionBox: 'rounded-lg border border-purple-200 dark:border-purple-800/50 bg-purple-100 dark:bg-purple-900/40 p-3 shadow-sm dark:shadow-lg dark:shadow-purple-950/30',
        suggestionText: 'text-purple-900 dark:text-purple-200',
        suggestionSubtext: 'text-purple-800 dark:text-purple-300',
        inputArea: 'border-t-2 border-neutral-200 dark:border-neutral-700 bg-gradient-to-br from-neutral-50 to-white dark:from-neutral-800/50 dark:to-neutral-800',
        inputField: 'border-2 border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm focus-within:border-purple-500 dark:focus-within:border-purple-400 focus-within:ring-2 focus-within:ring-purple-200 dark:focus-within:ring-purple-900/50',
        userBubble: 'bg-blue-50 dark:bg-blue-900/30 text-blue-900 dark:text-blue-100 border border-blue-200 dark:border-blue-800',
        assistantBubble: 'bg-neutral-50 dark:bg-neutral-800/50 text-neutral-900 dark:text-neutral-100 border border-neutral-200 dark:border-neutral-700',
        timestamp: 'text-neutral-500 dark:text-neutral-500',
    },
    // Settings panel - Deep dark mode
    settings: {
        panel: 'rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm dark:shadow-lg dark:shadow-neutral-950/30',
        header: 'border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/50',
