    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-neutral-300 bg-white py-3 pr-10 pl-10 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 focus:outline-none dark:border-neutral-600 dark:bg-zinc-950 dark:text-neutral-100 dark:text-neutral-600"
        />
        {query && (
          <button
            onClick={() => {
      ...
      {isOpen && (
        <div
          ref={resultsRef}
          className="absolute z-50 mt-2 max-h-64 w-full overflow-y-auto rounded-xl border border-neutral-200 bg-white shadow-lg dark:border-neutral-700 dark:bg-zinc-950"
        >
          {isLoading ? (
