    ...
    <div className="flex flex-col gap-4">
        ...
        {MEAL_TYPES.map(({ key, label, Icon }) => (
          <button
            ...
            className={cn(
              ...
              mealType === key
                ? 'bg-white text-emerald-700 shadow-sm dark:bg-white/[0.04] dark:text-emerald-400'
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            'w-full rounded-xl border border-neutral-200/60 bg-white py-2.5 pl-10 pr-4 text-sm outline-none transition-colors',
            'placeholder:text-neutral-400 focus:border-primary-400 focus:ring-2 focus:ring-primary-400/20',
            'dark:border-white/[0.08] dark:bg-zinc-950 dark:text-neutral-100 dark:focus:border-primary-500'
          )}
        />
        {search && (
          <button
          ...
          <div className="flex flex-col gap-2">
            {mealPresets.map((preset) => (
              <button
                ...
                className={cn(
                  'flex items-center justify-between rounded-xl border border-neutral-200/60 bg-white px-4 py-3 text-left transition-all duration-200',
                  'hover:border-primary-300 hover:bg-emerald-50/50',
                  'dark:border-white/[0.08] dark:bg-zinc-950 dark:hover:border-primary-700 dark:hover:bg-emerald-950/30'
                )}
              >
                <div>
                  <span className="text-sm font-medium text-neutral-800 dark:text-neutral-100">
        ...
        <div className="rounded-xl border border-neutral-200/60 bg-white p-4 dark:border-white/[0.08] dark:bg-zinc-950">
          ...
          <div className="grid grid-cols-2 gap-2">
            <input
              ...
              className="col-span-2 rounded-lg border border-neutral-200/60 bg-neutral-50 px-3 py-2 text-sm outline-none focus:border-primary-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-100"
            />
            <input
              type="number"
              inputMode="numeric"
              ...
              className="rounded-lg border border-neutral-200/60 bg-neutral-50 px-3 py-2 text-sm outline-none focus:border-primary-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-100"
            />
            <input
              type="number"
              inputMode="numeric"
      ...
      {/* ── Running Total ────────────────────────────────────────────────── */}
      {selected.size > 0 && (
        <div className="rounded-xl border border-neutral-200/60 bg-neutral-50 p-3 dark:border-white/[0.08] dark:bg-zinc-950">
