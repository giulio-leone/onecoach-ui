      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="mt-1 w-full touch-manipulation resize-none rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-sm shadow-sm transition-all duration-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-none dark:border-neutral-600 dark:bg-zinc-950"
          />
        </div>
