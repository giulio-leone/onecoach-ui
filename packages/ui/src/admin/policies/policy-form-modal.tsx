        ...
        <div className="space-y-6">
          ...
          {!isEditing && (
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-neutral-300 px-4 py-2 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none dark:border-neutral-600"
                required
              >
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className="flex-1 rounded-r-lg border border-neutral-300 px-4 py-2 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none dark:border-neutral-600"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-neutral-300 px-4 py-2 font-mono text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none dark:border-neutral-600"
              rows={15}
