...
export function CategoriesMultiselect({ values, onChange }: CategoriesMultiselectProps) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute z-20 mt-1 max-h-72 w-full overflow-auto rounded-md border border-neutral-200 bg-white p-2 shadow-lg dark:border-neutral-700 dark:bg-neutral-900">
          <input
