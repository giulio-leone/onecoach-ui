    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-1 flex-col gap-4">
        ...
        <div>
          ...
          <textarea
            className="h-60 w-full rounded-xl border border-neutral-300 bg-white px-4 py-3 text-sm text-neutral-800 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 focus:outline-none dark:border-neutral-600 dark:bg-zinc-950 dark:text-neutral-200"
