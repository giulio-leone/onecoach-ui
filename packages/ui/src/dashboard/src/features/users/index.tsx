    ...
    <div className="container mx-auto max-w-[1600px] px-4 py-6 sm:py-8">
      ...
      <AdminTabPanel activeTab={activeTab} tabId="users">
        <div className="space-y-4 sm:space-y-6">
          {/* Filters Bar */}
          <div className="flex flex-col gap-3 rounded-xl border border-neutral-200/60 bg-white p-3 shadow-sm sm:p-4 dark:border-white/[0.08] dark:bg-neutral-900/50">
          ...
          {isLoadingUsers ? (
            ...
            <div className="space-y-2">
              {filteredUsers.map((user: any) => (
                <div
                  key={user.id}
                  className="flex items-center gap-4 rounded-lg border border-neutral-200/60 bg-white p-4 dark:border-white/[0.08] dark:bg-neutral-900/50"
                >
                  {/* Avatar */}
          ...
          {/* Pagination */}
          <div className="flex flex-col gap-3 rounded-xl border border-neutral-200/60 bg-white p-3 shadow-sm sm:flex-row sm:items-center sm:justify-between dark:border-white/[0.08] dark:bg-neutral-900/50">
