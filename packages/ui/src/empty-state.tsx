...
export const EmptyState = ({ icon: Icon, title, description, action }: EmptyStateProps) => {
  return (
    <div className="animate-fadeIn mt-20 text-center text-neutral-500">
      <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full border border-neutral-200/60 bg-gradient-to-br from-neutral-100 to-neutral-50">
