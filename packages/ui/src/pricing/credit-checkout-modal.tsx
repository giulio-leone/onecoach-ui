...
export function CreditCheckoutModal({ open, pack, onClose, onCheckout }: CreditCheckoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-zinc-950">
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="grid gap-6 bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-500 p-6 text-white sm:grid-cols-[1.2fr,1.4fr]">
          ...
          <div className="rounded-2xl bg-white p-6 text-neutral-900 shadow-lg dark:bg-zinc-950 dark:text-neutral-100">
