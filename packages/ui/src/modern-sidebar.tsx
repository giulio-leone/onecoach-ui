      ...
      <div className="mt-auto border-t border-neutral-200/50 bg-neutral-50/30 p-4 backdrop-blur-sm dark:border-white/[0.06] dark:bg-white/[0.03]">
        {!isCollapsed ? (
          <div className="space-y-4">
            ...
            {/* User Info */}
            <div className="relative rounded-xl border border-transparent bg-transparent transition-colors hover:border-neutral-200/60 hover:bg-white hover:shadow-sm dark:hover:border-white/[0.12] dark:hover:bg-white/[0.06]">
              <button
