...
import type { TimelineEventType } from '@giulio-leone/lib-core/user-memory/types';
  ...
  return (
    <div className={cn('space-y-4', className)}>
      <Card variant="glass" padding="md">
        ...
        {showAddForm && (
          <div className="space-y-4 rounded-lg border border-neutral-200/60 bg-neutral-50/50 p-4 dark:border-white/[0.08] dark:bg-neutral-800/50">
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-neutral-200/60 bg-white px-3 py-2 text-sm dark:border-white/[0.08] dark:bg-zinc-950"
              >
