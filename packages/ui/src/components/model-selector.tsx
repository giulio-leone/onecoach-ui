    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mb-4 flex gap-2 shrink-0">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="h-9 pl-8 bg-neutral-50 dark:bg-white/5 border-neutral-200 dark:border-white/10"
            autoFocus={!isMobile}
          />
        </div>
        <div className="w-1/3">
          <Select
            ...
            className="h-9 text-xs bg-neutral-50 dark:bg-white/5 border-neutral-200 dark:border-white/10"
          >
      ...
      <div className={cn(
        ...
        {isLoading ? (
          ...
          <div className="p-8 text-center text-xs text-neutral-500 bg-neutral-50 dark:bg-white/5 rounded-xl">
            No models found.
          </div>
        ) : (
          filteredModels.map((model: any) => (
            <div
              ...
              className={cn(
                ...
                value === model.id 
                  ? 'bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20' 
              ...
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  value === model.id 
                    ...
                    : "bg-neutral-100 text-neutral-500 dark:bg-white/5 dark:text-neutral-400 group-hover:bg-white group-hover:shadow-sm dark:group-hover:bg-white/10"
                )}>
                ...
                <div className="flex flex-col">
                  <span className={cn(
                    "font-medium",
                    value === model.id ? "text-indigo-900 dark:text-indigo-100" : "text-neutral-700 dark:text-neutral-200"
                  )}>
                    {model.name}
                  </span>
    ...
    <div className={cn('relative inline-block', className)} ref={containerRef}>
      ...
      <button
        ...
        className={cn(
          ...
          "bg-white/50 backdrop-blur-md border border-neutral-200/50 hover:bg-white/80 hover:shadow-md hover:border-neutral-300/50",
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-neutral-700 dark:text-neutral-200 max-w-[120px] truncate">
      ...
      {isMobile ? (
        ...
        /* Desktop Dropdown */
        isOpen && (
          <div className="absolute top-full left-0 z-50 mt-2 w-[320px] origin-top-left rounded-2xl border border-white/20 bg-white/80 p-3 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-neutral-900/80 animate-in fade-in zoom-in-95 duration-200">
            <ModelListContent />
          </div>
        )
      )}
