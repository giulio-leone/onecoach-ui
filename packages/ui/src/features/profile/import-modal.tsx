    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div
            className="cursor-pointer rounded-xl border-2 border-dashed border-neutral-200 p-8 text-center transition-colors hover:bg-neutral-50 dark:border-white/[0.08] dark:hover:bg-white/[0.06]"
