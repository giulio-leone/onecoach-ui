...
export function ProgramInfoCard({
  ...
  return (
    <div
      className={cn(
        'mb-8 overflow-hidden rounded-2xl border border-neutral-200/60 bg-gradient-to-br p-6 shadow-lg transition-all duration-200 hover:shadow-xl dark:border-white/[0.08] dark:shadow-2xl dark:shadow-neutral-950/50 dark:hover:shadow-neutral-950/70',
        gradientFrom,
