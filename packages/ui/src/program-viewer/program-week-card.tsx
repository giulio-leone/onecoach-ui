...
export function ProgramWeekCard({
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-2xl border border-neutral-200/60 bg-white p-6 shadow-lg transition-all duration-200 hover:shadow-xl dark:border-white/[0.08] dark:bg-zinc-950',
        className
      )}
    >
      <div className="mb-6">
