...
export function ProgramGoalsSection({
  ...
  return (
    <div
      className={cn(
        'mb-8 rounded-2xl border border-neutral-200 bg-white p-6 shadow-lg transition-all duration-200 hover:shadow-xl dark:border-neutral-700 dark:bg-zinc-950',
        className
      )}
    >
