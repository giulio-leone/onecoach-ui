  ...
  return (
    <div className="flex items-center gap-3">
      <button
        type="button"
        onClick={() => adjust(-0.1)}
        className="flex h-10 w-10 items-center justify-center rounded-lg border border-neutral-200/60 bg-white text-neutral-600 transition-colors hover:bg-neutral-50 active:bg-neutral-100 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-neutral-300 dark:hover:bg-white/[0.08]"
      >
      ...
      <div className="relative">
        <input
          ...
          className="h-14 w-28 rounded-xl border border-neutral-200/60 bg-white text-center text-2xl font-bold text-neutral-900 outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white dark:focus:border-primary-500 dark:focus:ring-primary-500/20"
        />
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="rounded-lg border border-neutral-200/60 bg-white px-3 py-1.5 text-sm text-neutral-900 outline-none focus:border-primary-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white"
        />
      </div>
                ...
                <div key={f.key} className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="h-8 w-full rounded-lg border border-neutral-200/60 bg-white px-2 pr-7 text-sm text-neutral-900 outline-none focus:border-primary-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white"
                    />
      ...
      <textarea
        ...
        rows={2}
        className="w-full rounded-xl border border-neutral-200/60 bg-white px-4 py-3 text-sm text-neutral-900 outline-none placeholder:text-neutral-400 focus:border-primary-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white"
      />
