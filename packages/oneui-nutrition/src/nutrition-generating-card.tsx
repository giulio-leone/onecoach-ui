...
import { Utensils, Loader2, CheckCircle2, XCircle, Clock } from 'lucide-react';
...
/**
 * Props for NutritionGeneratingCard component
 */
export interface NutritionGeneratingCardProps {
  /** Generation data */
...
/**
 * NutritionGeneratingCard Component
 *
 * Displays an AI nutrition generation progress card with real-time updates.
 *
 * @example
 * ```tsx
 * <NutritionGeneratingCard
 *   generation={activeGeneration}
 *   onClick={() => navigateToDetails()}
 * />
 * ```
 */
export function NutritionGeneratingCard({
  generation,
  onClick,
  className,
  compact = false,
}: NutritionGeneratingCardProps) {
...
export default NutritionGeneratingCard;
